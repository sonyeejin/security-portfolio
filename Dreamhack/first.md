...
2진수 10010100이 있을 때  __부호가 없는 데이터(only +)__인 경우, 2의7승 + 2의4승+ 2의2승= 128+16+4=148
**부호가 있는 데이터(+또는 -)**인 경우, 2의 보수를 사용해서 구해야 함 
여기서 **2의 보수란** 0과 1이 역변환 된 것을 의미함 즉, 01101011로 바꾼 뒤 +1을 해준 수를 의미한다
최종적으로 01101100으로 108이 된다-> -108임
